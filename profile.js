...
//   function openModal() {
//     fetch(`https://social-2nd-project-backend-72na3ocnx.vercel.app/user/user_details/${userId}/`, {
//       method: "GET",
//       headers: {
//         Authorization: `Token ${token}`,
//         "Content-Type": "application/json",
...
async function fetchAndDisplayUserPosts(userId, token) {
  try {
    ...
    const apiUrl = `https://social-2nd-project-backend-72na3ocnx.vercel.app/crud/user/${userId}/posts/`;
      ...
      deleteButton.addEventListener("click", async () => {
        ...
        try {
          const deleteResponse = await fetch(
            `https://social-2nd-project-backend-72na3ocnx.vercel.app/crud/posts/${postId}/`,
            {
              method: "DELETE",
              headers: {
                Authorization: `Token ${token}`,
